...
::::: {.column width="54%"}
::: {style="font-size: 25px; margin-top: 2.4em;"}
...
::: {.takeaway style="margin-top: 1.6em;"}
...
::: {style="font-size: 27px; margin-top: 2.6em;"}

-   AI and digitalization have renewed debate about how jobs and tasks change
-   Adaptation increasingly emphasizes cognitive, analytical, and
    interpersonal capabilities
-   The opportunities and rewards attached to those capabilities may differ
    across occupational positions

::: {.takeaway style="margin-top: 1.7em;"}
We do not estimate the effect of AI. AI makes a more general question urgent:
**how is changing skill content distributed across occupations?**
:::
:::

## Pressure to Change Does Not Determine Where Content Takes Root {.smaller}

::: {style="font-size: 27px; margin-top: 2.5em;"}
...
::: {.takeaway style="margin-top: 1.7em;"}
The empirical problem is not only **which skills are demanded**, but
**where different kinds of skill content are added, retained, or shed.**
:::
:::
...
::: {.takeaway style="margin-top: 1em;"}
Han & Cheng show that the bottom diversifies but isn't rewarded;
we show why: the directional filter determines what content takes
root at each level.
:::
:::
