...
-   Recent job-posting evidence finds substantial skill diversification in
    low-wage jobs
-   But pressure to update need not translate into homogeneous changes in
...
## Gravity Models Treat Distance as Friction on Diffusion {.smaller}

::::::::: columns
::::: {.column width="62%"}
::: {style="font-size: 25px; margin-top: 1.25em;"}
**Gravity models**

-   Flows increase with attraction between origins and destinations
-   Related occupational profiles exert a stronger pull on one another
-   Greater task-profile distance makes skill updating less likely
:::

::: {.takeaway style="margin-top: 1.3em; font-size:22px;"}
Distance determines the **strength of attraction**, but because it is
symmetric, it cannot determine direction:
$\mathrm{dist}_{ij}=\mathrm{dist}_{ji}$.
:::

::: {style="font-size: 14px; margin-top: 0.45em; color:#717583;"}
Gravity framework: Tinbergen 1962. Task-profile relatedness: Hidalgo et al. 2007.
:::
:::::

::::: {.column width="38%"}
::: {style="text-align:center; margin-top: 0.35em;"}
![](newton_gravity.png){style="height:455px; width:auto; max-width:100%; object-fit:contain;"}
:::
:::::
:::::::::

## Status Adds an Asymmetric Force of Attraction {.smaller}

::::::::: columns
::::: {.column width="37%"}
::: {style="font-size: 20px; margin-top: 0.75em;"}
**Bottom-up cognitive upgrading**  
*Top-down cognitive borrowing*

::: {style="font-size: 24px; text-align:center; color:#0b7566; margin:0.55em 0;"}
Doctor holder $\longrightarrow$ Nurse target
:::

-   Replacement pressure is strongest at the bottom
-   Emulation encourages borrowing from occupations above
:::
:::::

::::: {.column width="26%"}
::: {style="text-align:center; margin-top: 0.15em;"}
![](newton_status.png){style="height:355px; width:auto; max-width:100%; object-fit:contain;"}
:::
:::::

::::: {.column width="37%"}
::: {style="font-size: 20px; margin-top: 0.75em;"}
**Upward cognitive sorting**  
*Unequal attraction and retention*

::: {style="font-size: 24px; text-align:center; color:#756fb3; margin:0.55em 0;"}
Nurse holder $\longrightarrow$ Doctor target
:::

-   Absorptive capacity and valuation may favor higher-status adopters
-   Licensing and credential closure may block downward borrowing
:::
:::::
:::::::::

::: {.takeaway style="margin-top: 0.55em; font-size:21px;"}
Relative status can make attraction **asymmetric**: the same proximity may
produce different updating probabilities depending on which occupation sits
above.
:::

::: {style="font-size: 12px; margin-top: 0.35em; color:#717583; text-align:center;"}
Bottom-up pressure and emulation: Strang & Macy 2001; Autor 2015; Tong et al.
2025; Han & Cheng 2026. Status-sorted forces: Cohen & Levinthal 1990; Abbott
1988; Weeden 2002; Kleiner 2013; Deming 2017.
:::
...
## From Occupational Data to Directed Risk Sets {.smaller}
