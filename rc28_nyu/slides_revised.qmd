...
-   More recently, AI has renewed expectations that work will rely more on
    cognitive skills
...
-   Skills cluster into socio-cognitive and sensory-physical domains
...
-   Nested dependencies locate skills in a hierarchy
...
::::::::: columns
::::: {.column width="50%"}
::: {style="font-size: 23px; margin-top: 1.25em;"}
**Generalized cognitive upgrading**

-   Technological pressure may extend cognitive requirements across the labor
    market
-   Lower-status occupations may face stronger pressure to update
-   Cognitive skills should therefore spread downward as well as upward
:::
:::::

::::: {.column width="50%"}
::: {style="font-size: 23px; margin-top: 1.25em;"}
**Status-sorted consolidation**

-   Emulation may pull some occupational content upward
-   Task allocation, absorptive capacity, closure, and valuation may retain
    cognitive content at the top
-   Sensory-physical content may concentrate downward
:::
:::::
:::::::::

::: {.takeaway style="margin-top: 1.15em; font-size: 21px;"}
We do not adjudicate among these mechanisms directly. We first ask a
descriptive question: is realized skill updating symmetric or
status-directed, and if status-directed, which direction predominates?
:::

::: {style="font-size: 13px; margin-top: 0.5em; color:#717583; text-align:center;"}
Generalized upgrading: Autor 2003; Acemoglu & Autor 2011; Tong et al. 2025;
Han & Cheng 2026. Status-sorted consolidation: Cohen & Levinthal 1990; Abbott
