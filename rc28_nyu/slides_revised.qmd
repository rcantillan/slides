...
**External validation (in progress).** We are extending the analysis to
ESCO and to the BLS Occupational Outlook Handbook (OOH), two occupational
classifications constructed independently of O\*NET.
:::
...
## External Validation: ESCO & OOH (In Progress) {.smaller}
...
- **Also underway.** A parallel validation using the BLS **Occupational
  Outlook Handbook (OOH)** as a third, independently constructed source.
:::

::: {.takeaway style="margin-top:1.2em; font-size:21px;"}
Both ESCO and OOH validations are **ongoing work**; ESCO currently offers
partial external validation in a classification built independently of
O\*NET.
:::
