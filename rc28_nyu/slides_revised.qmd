...
**External validation.** An ESCO-based analysis provides partial validation
using an occupational classification constructed independently of O\*NET.
:::
...
## External Validation: ESCO {.smaller}

::: {style="font-size:24px; margin-top:1.4em;"}
**Independent occupational classification**

- ESCO provides a distinct mapping between occupations and skills.
- Skill communities and functional classes are reconstructed entirely
  within ESCO, without using O\*NET classifications or skill labels.
- We reproduce the same directed **source–target–skill opportunity
  design**, crossing occupational relatedness with the signed status gap.

**What is reproduced**

- Higher-status targets are more likely to adopt **general
  socio-cognitive skills**.
- Higher-status targets are also more likely to adopt **specialized
  socio-cognitive skills**.
- Sensory-physical content is more likely to be abandoned toward the
  top, producing its relative consolidation among lower-status
  occupations.

**What is not reproduced**

- The socio-cognitive abandonment gradients and the sensory-physical
  adoption gradient are not estimated precisely in ESCO.
:::

::: {.takeaway style="margin-top:1.05em; font-size:21px;"}
ESCO provides **partial external validation** of the directional
consolidation pattern, but not a complete replication of every adoption
and abandonment gradient.
:::

::: {style="margin-top:0.7em; font-size:17px; color:#666666;"}
ESCO is a European occupational classification, not a country-specific
longitudinal labor-market dataset.
:::
