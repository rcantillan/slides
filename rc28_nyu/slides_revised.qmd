...
## Panel A: Skill Change Is Directed Around Fixed Sources {.smaller}
...
## Panel B: The Same Pattern Holds Around Fixed Targets {.smaller}
...
## The Signed-Gap Model Recovers the Aggregate Pattern {.smaller}

::: {style="text-align: center; margin-top: 0.5em;"}
![](figures/png/fig3_linear_gap_projections_panelA.png){width="76%"}
:::

::: {.takeaway style="margin-top:0.35em; font-size:21px;"}
The relational model recovers the direction and much of the magnitude of the
observed occupational gradient.
:::
...
::: {style="font-size:27px; margin-top:2em;"}
...
-   Both margins are **status-directed**.

-   Socio-cognitive content is adopted and retained **upward**.

-   Sensory-physical content is adopted and retained **downward**.
:::

::: {.takeaway style="margin-top:1.35em; font-size:22px;"}
Together, these movements reproduce the occupational hierarchy: a
**Matthew effect in occupational skill content**.
:::
...
## Q&A: External Validation in Progress {.smaller}

::: {style="font-size:22px; margin-top:0.8em; text-align:center; color:#302a78;"}
With **Mauricio Bucca**, we are developing a matched-pair validation of the
directional pattern.
:::

::::::::: columns
::::: {.column width="56%"}
::: {style="font-size:22px; margin-top:1.1em; padding-right:1.4em;"}
**Case-selection design**

1.  Rank occupations using the same status measure.
2.  Compute profile distance and the signed status gap for every pair.
3.  Build a two-dimensional grid: **relatedness × status-gap direction and
    magnitude**.
4.  Within highly related pairs, compare negative, near-zero, and positive
    status gaps.
5.  Select **20–50 representative occupational pairs** for close inspection.
:::
:::::

::::: {.column width="44%"}
::: {style="font-size:22px; margin-top:1.1em; padding-left:1.4em; border-left:2px solid #d8dbe4;"}
**Candidate external evidence**

-   Occupational/job dictionaries and mobility resources used in work by
    **Xi Song**
-   Worker mobility or job-history data comparable to Song et al.
-   CV/résumé data, conditional on access and occupational crosswalk quality
:::
:::::
:::::::::

::: {.takeaway style="margin-top:1.2em; font-size:21px;"}
The test holds **relatedness approximately constant** and asks whether realized
skill change varies with the **direction and magnitude of status distance**.
:::
...
## B11: References — Technological Change and Updating {.smaller}
