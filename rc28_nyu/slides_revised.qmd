...
Labor markets also change through the **recomposition of existing
occupations**.
:::
...
::::: {.column width="32%"}
::: {style="text-align:center; margin-top: 3.6em;"}
![](newton_gravity.png){style="height:245px; width:auto; max-width:100%; object-fit:contain;"}
:::
:::::
:::::::::
...
::::::::: columns
::::: {.column width="32%"}
::: {style="text-align:center; margin-top: 3.4em;"}
![](newton_status.png){style="height:255px; width:auto; max-width:100%; object-fit:contain;"}
:::
:::::
...
## B1: Main Threats, Tests, and Results {.smaller}

::: {style="font-size: 17px; margin-top: 0.65em; line-height:1.18;"}
...
::: {.takeaway style="margin-top: 0.65em; font-size:19px;"}
Across these checks, the **domain-specific directional pattern remains**. The
evidence still identifies association, not direct transmission or one causal
mechanism.
:::
