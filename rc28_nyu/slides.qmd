...
## Demand Signals and Realized Flows Are Different Objects {.smaller}

::::::::: columns
::::: {.column width="50%"}
::: {style="font-size: 22px; text-align: center; margin-top: 0.8em;"}
**Job-ad studies**<br>
...
![](figures/png/demand_vs_realized_concept.png){width="90%"}
:::

::: {style="font-size: 21px; margin-top: 0.4em; text-align: center;"}
The relational question adds direction:<br>
<span style="color:#4f46a5; font-weight:700;">socio-cognitive skills move upward</span>
&nbsp;&nbsp;·&nbsp;&nbsp;
<span style="color:#175c50; font-weight:700;">sensory-physical skills move downward</span>.
:::
...
# I. DIRECTIONAL SKILL DIFFUSION {.center .middle background-color="#302a78"}
...
# III. DESCRIPTIVE PATTERNS {.center .middle background-color="#302a78"}
...
# IV. GRAVITY MODEL RESULTS {.center .middle background-color="#302a78"}
