...
::: {style="font-size: 24px; margin-top: 2em;"}
**What could generate a spurious directional pattern — and how we rule it out:**

-   **Mechanical index artifact** — RCA is relative by construction →
    freeze the 2015 denominator; re-estimate on raw importance change

-   **Confounded by stable propensities** — occupations/skills that are
    just generally active → source/target fixed effects; a common shock
    is further ruled out by a within-stratum permutation test

-   **Arbitrary measurement choices** — RCA threshold, status index,
    skill taxonomy → each varied independently; asymmetry survives

-   **One disruptive period driving it** — pandemic, generative AI →
    replicated across 2015-18, 2019-21, 2022-24
:::
