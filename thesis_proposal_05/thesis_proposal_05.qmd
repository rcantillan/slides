...
"While organizations are the ultimate hiring actors, our analysis conceptualizes and measures skill demand at the occupational level. This decision is grounded in both methodological necessity and theoretical rationale:
...
::: {.div style="font-size: 25px; text-align: left; margin-top: 3em;"}
Skill diffusion is  driven by:

- "Trajectory Channeling": How structure and status filter skill flows.
- "Positional Revaluation": How these very pathways actively construct skill value and status. 
These mechanisms generate the observed "Escalator" vs. "Lateral Drift" dynamics and (re)articulate occupational boundaries.
