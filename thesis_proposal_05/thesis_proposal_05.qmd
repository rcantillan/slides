...
::: {.r-fit-text style="font-size: 60px; text-align: center; margin-top: 1em;"} 
...
::: {.columns}
::: {.column width="50%"}
::: {.r-fit-text style="font-size: 30px; text-align: left; margin-top: 1em;"}
...
- However, the underlying mechanisms of *how* this polarization is maintained and how it interacts with occupational boundaries and status hierarchies remain poorly understood.
:::
:::
...
::: {.column width="50%"}
::: {.div style="font-size: 25px; text-align: left; margin-top: 1em;"}
...
**This Research:** Reveals HOW boundaries are actively constructed and status is assigned.
**Through the lens of skill diffusion *between occupations***.
