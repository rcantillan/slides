...
format: 
  revealjs:
    ...
    footer: "Cantillan & Bucca | INAS conference - Columbia University NYC | 2025"
---
...
- **Step 5: Descriptive Analysis**
  ...
  - Socioeconomic mobility matrices by quartiles
...
::: {.div style="font-size: 25px; text-align: left; margin-top: 3em;"}
- Sociocognitive skills exhibit strong upward mobility, flowing overwhelmingly towards the top quartile (Q4) for both wages and education, regardless of their starting quartile.

- Physical/Sensorymotor skills show predominantly lateral mobility, circulating mainly within the lower and middle quartiles (Q1-Q3) and demonstrating a "glass ceiling" effect, with very limited entry into Q4.
:::
...
Dual Diffusion Logics Unveiled (Descriptives & Model Confirmation):

- **Cognitive Skills ("The Escalator")**: Show consistent upward socioeconomic mobility (Q4). Models confirm this is primarily driven by educational advancements and an affinity for moderate structural shifts, with wage effects being secondary.

- **Physical/Technical Skills ("The Lateral Drift")**: Exhibit lateral circulation (Q1-Q3). Models verify this is due to strong constraints from structural proximity and significant educational/wage ceilings.
Skill Diffusion as an Active Stratification Engine:


These asymmetric pathways—whose drivers are clarified by our models—are not mere market trends. They function as core mechanisms that actively (re)articulate occupational boundaries, (re)value skills based on trajectory, and drive labor market polarization.
...
**Core Mechanisms Driving Stratification**
*Labor market inequality is actively produced by dynamic skill diffusion mechanisms:*

  - "Trajectory Channeling": Occupational structure and status hierarchies don't just exist; they actively filter and direct distinct skill flows.
  - "Positional Revaluation": Consequently, these divergent pathways dynamically construct and alter a skill's market value and an occupation's status.

**From Mechanisms to Observed Inequality**
*These core mechanisms are what visibly generate:*

  - The "Escalator" vs. "Lateral Drift" dynamics for different skill types.
  - The ongoing (re)articulation of occupational boundaries and patterns of social closure.
