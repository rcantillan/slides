...
- **Factores influyentes**: Factores como la educación, la desigualdad económica y la similitud de requisitos de estatus y habilidades en las ocupaciones han sido identificados como elementos que afectan la movilidad laboral (Hauser, 1980; Hout, 1984; DiPrete, 1987; Stier & Grusky, 1990). 
  
--

- **Agrupación de ocupaciones**: Algunos estudios han analizado cómo las ocupaciones se agrupan en categorías (cuello blanco, cuello azul, servicios, etc.) según los flujos de trabajadores entre ellas (Goodman, 1981; Snipp, 1985; Breiger, 1974).
...
- **Perspectiva de redes y capital social**: Investigaciones más recientes han aplicado la perspectiva de redes sociales para entender la estructura ocupacional, enfocándose en cómo las conexiones entre ocupaciones influyen en la movilidad y el acceso a recursos. Además, ha resaltado la dinámica de segregación y el contagio entre distintos campos laborales, enfatizando en cómo las estructuras limitan o facilitan el acceso a recursos para grupos específicos (Villarreal, 2020; Cheng, 2020; Lin 2022; Fernandez & Fernandez-Mateo, 2006).
...
- El análisis clásico de movilidad ocupacional, fundamentado en esquemas jerárquicos de clase basados en características como prestigio, estatus, habilidades y autoridad ({Blau, 1978; Breiger, 1981), a menudo omite la atención detallada a los flujos interiores entre ocupaciones. 

--

- En efecto, las investigaciones han avanzado en mapear patrones de movilidad entre "clases ocupacionales", pero han pasado por alto flujos específicos entre "ocupaciones", que son cruciales para detectar límites "latentes" que restringen la movilidad individual a un nivel micro (Cheng & Park, 2020, p. 579).
...
- En comparación con enfoques anteriores de movilidad ocupacional, el enfoque basado en redes destaca: 
...
- La movilidad entre ocupaciones es esencial para entender la estructura ocupacional y constituye a la estructura, lo que refuta la noción de falta de estructura en la movilidad ocupacional.
...
- La estructura ocupacional se puede ver como un **sistema adaptativo de intercambio generalizado** (Bearman, 1997) donde las ocupaciones con atributos variables se conectan mediante el movimiento de trabajadores, respondiendo a choques exógenos y procesos de red endógenos.
...
### **Evidencia Reciente sobre Redes en el Mercado Ocupacional**


- Las redes ocupacionales tienden a segregarse y esta segregación aumenta con el tiempo, especialmente en Estados Unidos (Lin & Hung, 2022; Cheng & Park, 2020).

--

- Los grupos ocupacionales se han diferenciado más con el tiempo, con menos superposición entre ellos, especialmente en ocupaciones de alto estatus (Lin & Hung, 2022). Esto sugiere mayor especialización y aislamiento de ocupaciones de alto estatus.

--

- Aumento de segmentos en sectores industrial y de servicios debido a mayores intercambios internos y menos entre comunidades ocupacionales (Villarreal, 2020; Lin & Hung, 2022; Cheng & Park, 2020).

---

class: middle left

### **Evidencia Reciente sobre Redes en el Mercado Ocupacional II**



- Trabajadores de bajos salarios experimentan mayor homogeneidad ocupacional en los lugares de trabajo, relacionado con salarios más bajos, mientras que ocupaciones más grandes ofrecen seguridad laboral en recesiones (Villarreal, 2020; Cheng & Park, 2020).

--

- Atributos como género, raza, educación, edad y tareas afectan el flujo de trabajadores, influyendo en la dispersión salarial entre ocupaciones (Cheng & Park, 2020).

--

- La movilidad laboral influye entre ocupaciones y puede causar contagio en patrones de empleo y condiciones económicas en grupos conectados (Lin & Hung, 2022).
...
- Describir la estructura emergente de modo general 
